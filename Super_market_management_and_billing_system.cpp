...
public:
   ...
   int calBill(int bill)
   {
       ...
       else
       {
           ...
           cout<<setw(15)<<"Price of "<<n<<" quantity is Rs."<<bookcost<<endl;
           bill=bill+bookcost;
...
int main()
{
   ...
   hash1();
   cout<<setw(70)<<"WELCOME TO THE DEV SUPERMARKET\n";
   hash1();
   ...
   else if(ch==2)
   {
       ...
       do
       {
        ...
        cout<<"\n\t0- Go to login page"<<endl;
           ...
           case 4:
               cout<<"\n$$$$ Dev Super market Here is your bill$$$$\n"<<endl;
